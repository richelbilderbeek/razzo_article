...
for example \richel{@gio: please add examples}.
...
The MBD model has \richel{@gio: how many?} parameters, depicted in table \ref{table:parameters}. 

\richel{@gio: describe parameter values used here, example is below}
...
For each combination of \richel{@gio: parameter values here}, 
